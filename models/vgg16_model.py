...
def train_custom_vgg16(normalized_train_data, normalized_test_data, train_generator, test_generator, batch_size=32,
                       epochs=10):
    model = Sequential([
    ...
    history_vgg16_custom = model.fit(train_generator, steps_per_epoch=len(normalized_train_data[0]) // batch_size,
